...
public interface IBookService
{
    ...
    Task<Result<int>> CountAsync(BookSearchDto search, CancellationToken cancellationToken = default);
    ...
    Task<Result<IReadOnlyList<string>>> GetAuthorsAsync(CancellationToken cancellationToken = default);
